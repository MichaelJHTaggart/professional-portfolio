...
const Body = props => {
  ...
  window.addEventListener("scroll", function () {
    ...
    document.getElementById("parallax-image-1").style.backgroundPositionY = offset * 1 + "px";
    document.getElementById("parallax-image-right").style.backgroundPositionY = offset * 1 + "px";
    document.getElementById("parallax-image-2").style.backgroundPositionY = offset * 1 + "px";
    document.getElementById("parallax-image-left").style.backgroundPositionY = offset * 1 + "px";
  })
