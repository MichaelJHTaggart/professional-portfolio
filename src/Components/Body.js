...
const Body = props => {
 ...
 const parallax = document.getElementById("parallax-image-1");
 ...
 window.addEventListener("scroll", function () 
 {
   ...
   //  parallax.style.bagroundPositionY = offset * 0.7 + "px"
 })
...
<section className="body">
  ...
  <h2>Property Management</h2>
   ...
   <div id="parallax-image-right-fixed">
...
{/* <div className="project-banner-left">
 ...
 <div id="parallax-image-left-fixed">  
